...
public class RESTfulController {
	...
	@CrossOrigin
	@RequestMapping(value = "/techDebt/{projectId}", method = RequestMethod.GET, produces = "application/json; charset=UTF-8")
	public ArrayList<DailyData> showAllTectDebtinMonth(@PathVariable("projectId") int projectId) throws ParseException {
